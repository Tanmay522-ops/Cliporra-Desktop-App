...
function createWindow() {
  ...
  if (VITE_DEV_SERVER_URL) {
    const devUrl = VITE_DEV_SERVER_URL.endsWith("/") ? VITE_DEV_SERVER_URL : `${VITE_DEV_SERVER_URL}/`;
    win.loadURL(devUrl);
    studio.loadURL(`${devUrl}studio.html`);
    floatingWebCam.loadURL(`${devUrl}webcam.html`);
  } else {
